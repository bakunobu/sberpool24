...
def main():
    ...
    # Button handler (must come before specific CallbackQueryHandlers)
    app.add_handler(CallbackQueryHandler(button_handler))  # ← This handles add_player, add_game, show_stats, etc.
